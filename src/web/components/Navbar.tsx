...
// Active section detection — watches which section is in viewport
  ...
  return (
    ...
    >
      <div style={{
        ...
        >
          <span style={{
            fontSize: "1.0rem", fontWeight: 600, letterSpacing: "-0.03em",
          ...
          {links.map(({ label, id }) => {
            ...
            return (
              <a
                ...
                style={{
                  fontSize: "0.8125rem",
                  // Active: slightly brighter than inactive hover state
              ...
              >
                {label}
                {/* Active dot — barely visible, no animation */}
                {isActive && (
                  <span style={{
                    position: "absolute",
                    bottom: -6,
